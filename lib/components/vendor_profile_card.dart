...
class VendorProfileCard extends StatelessWidget {
  final VendorCard vendorData;

  VendorProfileCard(this.vendorData);
    ...
    return GestureDetector(
        onTap: () {
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) =>
                    VendorProfilePage(isHall: false,isUser:true,id:vendorData.id)),
          );
        },
        child: Container(
          height: 146,
          ...
          child: Card(
            ...
            child: Padding(
              ...
              child: Row(children: [
                Expanded(
                  flex: 1,
                  child:vendorData.profile_thumbnail == ' ' ?CircleAvatar(
                    backgroundImage: AssetImage('assets/svg/user.svg'),
                    radius: 150,
                  ):
            CircleAvatar(
              backgroundImage: NetworkImage(apiUrl+"storage/UserPhoto/VendorProfile/"+vendorData.profile_thumbnail),
              radius: 150,
            ),
                ),
                Expanded(
