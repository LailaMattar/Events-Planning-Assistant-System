...
class Report extends StatefulWidget {
  ...
  @override
  _ReportState createState() => _ReportState(this.vid);
}

class _ReportState extends State<Report> {
  int vid;

  _ReportState(this.vid);
        ...
        body: SafeArea(
          child: Column(children: [
            ...
            Padding(
              ...
              child: BigButton(
                ...
                onTap: () async {
                  ...
                  res = await _bloc.report(Rep(reason: reason, vendor_id: vid));
                },
            ...
            Visibility(
              ...
              child: StreamBuilder<ApiResponse<Rep>>(
